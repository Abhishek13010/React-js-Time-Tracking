        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link  " href="../pages/virtual-reality.html">
                  ...
                  <span class="nav-link-text ms-1">Screensort</span>
                </a>
              </li>
              <li class="nav-item">
          ...
          {/* <div class="sidenav-footer mx-3 ">
            <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
              <div class="full-background" style={{ backgroundImage: "url('../assets/img/curved-images/white-curved.jpg')" }}></div>
      ...
      <div class="col col-lg-9 col-xl-7">
        <div class="card rounded-3">
          <div class="card-body p-4">
            ...
            <h4 class="text-center my-3 pb-3">To Add Project</h4>

            <form class="row row-cols-lg-auto g-3 justify-content-center align-items-center mb-4 pb-2">
              <div class="col-12">
                <div class="form-outline">
                  <input type="text" id="form1" class="form-control" />
                  <label class="form-label" for="form1">Enter a project here</label>
                </div>
              </div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex px-2 py-1">
                                ...
                                <div class="d-flex flex-column justify-content-center">
                                  <h6 class="mb-0 text-sm">Time Tracking</h6>
                                  {/* <p class="text-xs text-secondary mb-0">john@creative-tim.com</p> */}
                                </div>
                              </div>
                            </td>
                            <td>
                              <p class="text-xs font-weight-bold mb-0">MERN Stack</p>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex px-2 py-1">
                                ...
                                <div class="d-flex flex-column justify-content-center">
                                  <h6 class="mb-0 text-sm">E-Exam</h6>
                                  {/* <p class="text-xs text-secondary mb-0">alexa@creative-tim.com</p> */}
                                </div>
                              </div>
                            </td>
                            <td>
                              <p class="text-xs font-weight-bold mb-0">PHP</p>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex px-2 py-1">
                                ...
                                <div class="d-flex flex-column justify-content-center">
                                  <h6 class="mb-0 text-sm">To Do List</h6>
                                  {/* <p class="text-xs text-secondary mb-0">laurent@creative-tim.com</p> */}
                                </div>
                              </div>
                            </td>
                            <td>
                              <p class="text-xs font-weight-bold mb-0">MEAN Stack</p>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex px-2">
                                ...
                                <div class="my-auto">
                                  <h6 class="mb-0 text-sm">PG Management</h6>
                                </div>
                              </div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex px-2">
                                ...
                                <div class="my-auto">
                                  <h6 class="mb-0 text-sm">Bug Tracking</h6>
                                </div>
                              </div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex px-2">
                                ...
                                <div class="my-auto">
                                  <h6 class="mb-0 text-sm">Gym Management</h6>
                                </div>
                              </div>
                            </td>
                            <td>
                ...
                <div class="row align-items-center justify-content-lg-between">
                  <div class="col-lg-6 mb-lg-0 mb-4">
                    <div class="copyright text-center text-sm text-muted text-lg-start">
                      ...
                      made with <i class="fa fa-heart"></i> by Abhishek Prajapati for a better web.
