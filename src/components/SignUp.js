    ...
    <div>
      ...
      <body class="">
        ...
        <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4">
          <div class="container">
            <Link class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" to="/">
              Soft UI Dashboard
            </Link>
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto ms-xl-auto me-xl-7">
                <li class="nav-item">
                  <Link class="nav-link d-flex align-items-center me-2 active" aria-current="page" to="/">
                    <i class="fa fa-chart-pie opacity-6  me-1"></i>
                    Dashboard
                  </Link>
                </li>
                <li class="nav-item">
                  <Link class="nav-link me-2" to="/profile">
                    <i class="fa fa-user opacity-6  me-1"></i>
                    Profile
                  </Link>
                </li>
                <li class="nav-item">
                  <Link class="nav-link me-2" to="/signup">
                    <i class="fas fa-user-circle opacity-6  me-1"></i>
                    Sign Up
                  </Link>
                </li>
                <li class="nav-item">
                  <Link class="nav-link me-2" to="/signin">
        ...
        <main class="main-content  mt-0">
          <section class="min-vh-100 mb-8">
            <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style={{ backgroundImage: "url('../assets/img/curved-images/curved14.jpg')" }}>
                  ...
                  <div class="card z-index-0">
                    ...
                    <div class="card-body">
                      <form role="form text-left" onSubmit={submit}>
                        <div class="mb-3">
                          <input type="text" class="form-control" placeholder="Name" aria-label="Name" aria-describedby="email-addon" onChange={(e) => { setfirstName(e.target.value) }} />
                        </div>
                        <div class="mb-3">
                          <input type="email" class="form-control" placeholder="Email" aria-label="Email" aria-describedby="email-addon" onChange={(e) => { setemail(e.target.value) }} />
                        </div>
                        <div class="mb-3">
                          <input type="password" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="password-addon" onChange={(e) => { setpassword(e.target.value) }} />
                        </div>
                        <div>
                          <input type="radio" value="6233d6ffe3455be1c3b654d3" name='role' onChange={(e) => { setrole(e.target.value) }} />Admin <br></br>
                          <input type="radio" value="6233d72ae3455be1c3b654d7" name='role' onChange={(e) => { setrole(e.target.value) }} />Project Manager<br></br>
                          <input type="radio" value="6233d715e3455be1c3b654d5" name='role' onChange={(e) => { setrole(e.target.value) }} />Developer
                        ...
                        <p class="text-sm mt-3 mb-0">Already have an account? <Link to="/signin" class="text-dark font-weight-bolder">Sign in</Link></p>
                      </form>
                    </div>
                  </div>
                </div>
